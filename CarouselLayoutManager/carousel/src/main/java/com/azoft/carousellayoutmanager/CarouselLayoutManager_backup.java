 ...
 * Generally there is one center item and bellow this item there are maximum {@link CarouselLayoutManager_backup#getMaxVisibleItems()} items on each side of the center
 * item. By default {@link CarouselLayoutManager_backup#getMaxVisibleItems()} is {@link CarouselLayoutManager_backup#MAX_VISIBLE_ITEMS}.<br />
 * <br />
 * This LayoutManager supports only fixedSized adapter items.<br />
 * <br />
 * This LayoutManager supports {@link CarouselLayoutManager_backup#HORIZONTAL} and {@link CarouselLayoutManager_backup#VERTICAL} orientations. <br />
 * <br />
 ...
 * So like layout_height is not {@link ViewGroup.LayoutParams#MATCH_PARENT} for {@link CarouselLayoutManager_backup#VERTICAL}<br />
 * <br />
 */
@SuppressWarnings({"ClassWithTooManyMethods", "OverlyComplexClass", "unused"})
public class CarouselLayoutManager_backup extends RecyclerView.LayoutManager implements RecyclerView.SmoothScroller.ScrollVectorProvider {
    ...
    public CarouselLayoutManager_backup(final int orientation) {
     ...
     */
    @SuppressWarnings("unused")
    public CarouselLayoutManager_backup(final int orientation, final boolean circleLayout) {
    ...
    /**
     * Setup {@link CarouselLayoutManager_backup.PostLayoutListener} for this LayoutManager.
